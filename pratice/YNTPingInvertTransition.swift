...
class PingInvertTransition: NSObject,UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let fromVC = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey) as! YNTTransitionSecondViewController
        let toVC = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as! YNTTransitionViewController
        let containerView = transitionContext.containerView()
        let button = toVC.transitionButton
